...
// Assume at repo top level (pubsubbeat directory) for 'go mod vendor' command
replace github.com/logrhythm/pubsubbeat latest => ./
...
require (
	...
	github.com/natefinch/lumberjack latest // WS v2.1.tar.gz pubsubbeat build error
	github.com/go-yaml/yaml latest // WS v2.2.1.tar.gz pubsubbeat build error
